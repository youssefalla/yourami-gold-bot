...
def webhook():
    try:
        ...
        send_email(direction, price, sl, tp, analysis)
...
def get_ai(direction, price, sl, tp):
    try:
        ...
        msg = client.messages.create(
            ...
            max_tokens=300,
            messages=[{"role": "user", "content": f"XAU/USD {direction} signal. Price: ${price:.2f}, SL: ${sl}, TP: ${tp}. Write 3 sentences: why valid, key levels, risk warning."}]
        )
